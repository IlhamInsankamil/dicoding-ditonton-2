...
void main() {
  ...
  group('search tv', () {
    final tSearchResult = TVResponse.fromJson(
        json.decode(readJson('dummy_data/tv_search_squid.json')))
        .tvList;
    final tQuery = 'name';
    ...
    test('should return list of tv when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
          readJson('dummy_data/tv_search_squid.json'), 200));
      // act
  ...
  group('get tv episodes', () {
    final tEpisodeList = SeasonModel.fromJson(
    ...
    test('should return list of TV Model when the response code is 200',
          ...
          // arrange
          when(mockHttpClient
              .get(Uri.parse('$BASE_URL/tv/$ttvId/season/$tSeasonNumber?$API_KEY')))
              .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv_episodes.json'), 200));
          // act
          final result = await dataSource.getEpisodes(ttvId, tSeasonNumber);
          // assert
    ...
    test('should throw Server Exception when the response code is 404 or other',
          ...
          when(mockHttpClient
              ...
              .thenAnswer((_) async => http.Response('Not Found', 404));
          // act
          final call = dataSource.getEpisodes(ttvId, tSeasonNumber);
          // assert
          expect(() => call, throwsA(isA<ServerException>()));
        });
  });
